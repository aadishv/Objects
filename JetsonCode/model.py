        ...
        def build_engine():
            ...
            with (
                ...
                config.max_workspace_size = (
                    1 << 28
                )  # Set maximum workspace size to 256MiB
    ...
    def inference(self, inputImage):
        ...
        postprocessor_args = {
            ...
            "obj_threshold": [
                ...
                0.50,
                0.50,
            ],  # Different thresholds for each class label (Green, Red, Blue)
            "nms_threshold": 0.5,
        ...
        obj_detected_img = Model.draw_bboxes(
            image_raw, boxes, scores, classes, ALL_CATEGORIES, Detections
        )
